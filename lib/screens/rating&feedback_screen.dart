    ...
    return Scaffold(
      ...
      body: Center(
        child: Stack(
          ...
          children: <Widget>[
            Image.asset(
              "assets/images/food_doodle_2.png",
              fit: BoxFit.cover,
              height: height,
              width: width,
            ...
            Padding(
              padding:
                  const EdgeInsets.only(bottom: 400.0, left: 30.0, right: 30.0),
              child: Text(
                'How is your experience with the app so far ?',
            ...
            Padding(
              padding:
                  const EdgeInsets.only(bottom: 110.0, left: 15.0, right: 30.0),
              child: Text(
